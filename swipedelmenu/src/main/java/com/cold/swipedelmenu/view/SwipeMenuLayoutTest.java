 ...
 * Date: 16/04/24
 */
public class SwipeMenuLayoutTest extends ViewGroup {
     ...
     * 存储的是当前正在展开的View
     */
    private static SwipeMenuLayoutTest mViewCache;
    ...
    public SwipeMenuLayoutTest(Context context) {
        this(context, null);
    }

    public SwipeMenuLayoutTest(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeMenuLayoutTest(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public SwipeMenuLayoutTest setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public SwipeMenuLayoutTest setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static SwipeMenuLayoutTest getViewCache() {
        return mViewCache;
    }
...
//                    isTouching = false;//没有手指在摸我了
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = SwipeMenuLayoutTest.this;
