package com.cold.audioview.loadview;
...
import com.cold.audioview.loadview.indicators.AudioScaleIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private static final AudioScaleIndicator DEFAULT_INDICATOR = new AudioScaleIndicator();
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor=a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, Color.BLACK);
    ...
    /**
     * 设置indicator，由外部传入，如果没有则使用默认DEFAULT_INDICATOR
     * @param
     * @return
     */
